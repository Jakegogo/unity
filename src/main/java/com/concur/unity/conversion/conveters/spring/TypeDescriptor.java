...
package com.concur.unity.conversion.conveters.spring;

import com.concur.unity.utils.Assert;
import com.concur.unity.utils.ClassUtils;
import com.concur.unity.utils.ObjectUtils;
...
public class TypeDescriptor implements Serializable {
	 ...
	 * <p>For example, {@code create(String.class).isAssignableTo(create(CharSequence.class))}
	 * returns {@code true} because a String value can be assigned to a CharSequence variable.
	 * On the other hand, {@code create(Number.class).isAssignableTo(create(Integer.class))}
	 ...
	 * like: {@code collection(List.class, TypeDescriptor.create(EmailAddress.class));}
	 ...
	 * <pre class="code">
	 * map(Map.class, TypeDescriptor.create(Id.class), TypeDescriptor.create(EmailAddress.class));
	 * </pre>
