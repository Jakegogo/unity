...
package com.concur.unity.conversion.conveters.spring.support;

import com.concur.unity.conversion.conveters.spring.ConversionFailedException;
import com.concur.unity.conversion.conveters.spring.TypeDescriptor;
import com.concur.unity.conversion.conveters.spring.converter.ConditionalGenericConverter;
import com.concur.unity.utils.ClassUtils;
 ...
 *
 * <p>Calls a static {@code create(sourceType)} or Java 8 style {@code of|from(sourceType)}
...
final class ObjectToObjectConverter implements ConditionalGenericConverter {
	...
	public Object convert(Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		throw new IllegalStateException("No static create/of/from(" + sourceClass.getName() +
	...
	static Method getOfMethod(Class<?> targetClass, Class<?> sourceClass) {
		Method method = ClassUtils.getStaticMethod(targetClass, "create", sourceClass);
		if (method == null) {
